...
public class Encrypt {
	...
	public Value<String> action(
			...
			@Pkg(label = "String to encrypt (Credential)")
			@NotEmpty
			SecureString word,
		...
		try {
			...
			String inputString = word.getInsecureString();
			byte[] encryptedTextBytes = cipher.doFinal(inputString.getBytes("UTF-8"));
			...
			return new StringValue("ER001: " + (var15 != null ? var15.getMessage() : "Unknown error"));
		}
